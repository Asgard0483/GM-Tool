      ...
      <div className={styles.formBody}>
        {step === 0 && (
          <div className={styles.formGrid}>
            ...
            <FormField label={t('characters.role')}><Input value={form.role} onChange={e => set('role', e.target.value)} /></FormField>
            <FormField label={t('characters.species')}><Input value={form.species} onChange={e => set('species', e.target.value)} /></FormField>
            <FormField label={t('characters.class')}><Input value={form.profession_class} onChange={e => set('profession_class', e.target.value)} /></FormField>
            <FormField label={t('characters.age')}><Input value={form.age} onChange={e => set('age', e.target.value)} /></FormField>
            <FormField label={t('characters.gender')}><Input value={form.gender} onChange={e => set('gender', e.target.value)} /></FormField>
            <FormField label={t('characters.origin')}><Input value={form.origin} onChange={e => set('origin', e.target.value)} /></FormField>
        ...
        {step === 1 && (
          <div className={styles.formStack}>
            <FormField label={t('characters.personality')}><Textarea value={form.personality} onChange={e => set('personality', e.target.value)} rows={4} /></FormField>
            <FormField label={t('characters.ideals')}><Textarea value={form.ideals} onChange={e => set('ideals', e.target.value)} rows={3} /></FormField>
            <FormField label={t('characters.fears')}><Textarea value={form.fears} onChange={e => set('fears', e.target.value)} rows={3} /></FormField>
            <FormField label={t('characters.weaknesses')}><Textarea value={form.weaknesses} onChange={e => set('weaknesses', e.target.value)} rows={3} /></FormField>
          </div>
        )}
        {step === 2 && (
          <div className={styles.formStack}>
            <FormField label={t('characters.goals')}><Textarea value={form.goals} onChange={e => set('goals', e.target.value)} rows={3} /></FormField>
            <FormField label={`${t('characters.secrets')} (GM Only)`}><Textarea value={form.secrets} onChange={e => set('secrets', e.target.value)} rows={3} /></FormField>
            <FormField label={t('characters.background')}><Textarea value={form.background} onChange={e => set('background', e.target.value)} rows={4} /></FormField>
            <FormField label={t('characters.importantEvents')}><Textarea value={form.important_events} onChange={e => set('important_events', e.target.value)} rows={3} /></FormField>
            <FormField label={t('characters.equipment')}><Textarea value={form.equipment} onChange={e => set('equipment', e.target.value)} rows={2} /></FormField>
            <FormField label={t('characters.stats')}><Textarea value={form.skills_stats_notes} onChange={e => set('skills_stats_notes', e.target.value)} rows={2} /></FormField>
          </div>
        )}
        {step === 3 && (
          <div className={styles.formStack}>
