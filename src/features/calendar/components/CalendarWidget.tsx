  ...
  return (
    <div className={styles.widget}>
      ...
      <div className={styles.actions}>
        <Button variant="secondary" size="sm" onClick={() => advanceTime(activeCampaignId, 0, 1)}>
          +1 Std
        </Button>
        <Button variant="secondary" size="sm" onClick={() => advanceTime(activeCampaignId, 0, 8)}>
          +8h
        </Button>
        <Button variant="secondary" size="sm" onClick={() => advanceTime(activeCampaignId, 1)}>
          +1 Tag
        </Button>
      </div>
    </div>
