...
export default function NewCharacterPage() {
  ...
  const validate = (): boolean => {
    ...
    if (!form.typ) errs.typ = `${t('common.type')} ${t('common.required_err')}`;
      ...
      <div className={styles.formBody}>
        {step === 0 && (
          <div className={styles.formGrid}>
            ...
            <FormField label={t('common.type')} error={errors.typ} required>
            ...
            <FormField label={t('characters.role')}>
              <Input value={form.rolle} onChange={e => set('rolle', e.target.value)} />
            </FormField>
            <FormField label={t('characters.species')}>
              <Input value={form.volk_spezies} onChange={e => set('volk_spezies', e.target.value)} />
            </FormField>
            <FormField label={t('characters.class')}>
              <Input value={form.beruf_klasse} onChange={e => set('beruf_klasse', e.target.value)} />
            </FormField>
            <FormField label={t('characters.age')}>
              <Input value={form.alter} onChange={e => set('alter', e.target.value)} />
            </FormField>
            <FormField label={t('characters.gender')}>
              <Input value={form.geschlecht} onChange={e => set('geschlecht', e.target.value)} />
            </FormField>
            <FormField label={t('characters.origin')}>
              <Input value={form.herkunft} onChange={e => set('herkunft', e.target.value)} />
            </FormField>
        ...
        {step === 1 && (
          <div className={styles.formStack}>
            <FormField label={t('characters.personality')}>
              <Textarea value={form.persoenlichkeit} onChange={e => set('persoenlichkeit', e.target.value)} rows={4} />
            </FormField>
            <FormField label={t('characters.ideals')}>
              <Textarea value={form.ideale} onChange={e => set('ideale', e.target.value)} rows={3} />
            </FormField>
            <FormField label={t('characters.fears')}>
              <Textarea value={form.aengste} onChange={e => set('aengste', e.target.value)} rows={3} />
            </FormField>
            <FormField label={t('characters.weaknesses')}>
              <Textarea value={form.schwaechen} onChange={e => set('schwaechen', e.target.value)} rows={3} />
            </FormField>
          </div>
        )}
        ...
        {step === 2 && (
          <div className={styles.formStack}>
            <FormField label={t('characters.goals')}>
              <Textarea value={form.ziele} onChange={e => set('ziele', e.target.value)} rows={3} />
            </FormField>
            <FormField label={`${t('characters.secrets')} (GM Only)`}>
              <Textarea value={form.geheimnisse} onChange={e => set('geheimnisse', e.target.value)} rows={3} />
            </FormField>
            <FormField label={t('characters.background')}>
              <Textarea value={form.hintergrund} onChange={e => set('hintergrund', e.target.value)} rows={4} />
            </FormField>
            <FormField label={t('characters.importantEvents')}>
              <Textarea value={form.wichtige_ereignisse} onChange={e => set('wichtige_ereignisse', e.target.value)} rows={3} />
            </FormField>
            <FormField label={t('characters.equipment')}>
              <Textarea value={form.ausruestung} onChange={e => set('ausruestung', e.target.value)} rows={2} />
            </FormField>
            <FormField label={t('characters.stats')}>
              <Textarea value={form.faehigkeiten_werte_notizen} onChange={e => set('faehigkeiten_werte_notizen', e.target.value)} rows={2} />
            </FormField>
          </div>
        )}
